...
function changePage(page) {
    ...
    var navigationPage = document.getElementById("navigationPageButtons");
    // Validate page
    current_page = page;
    if (page < 1) page = 1;
    if (page > numPages()) page = numPages();
    navigationPage.innerHTML = `<li class="page-item"><a class="page-link" href="javascript:prevPage()" id="btn_prev">Previous</a></li>`
    for (let l = 1; l < numPages() + 1 ; l++) {
        navigationPage.innerHTML += `<li class="page-item"><a class="page-link" href="javascript:changePage(${l})">${l}</a></li>`
    }
    navigationPage.innerHTML +=`<li class="page-item"><a class="page-link" id="btn_next" href="javascript:nextPage()">Next</a></li>`
